...
def main():
  ...
  html1="""
    <div style="text-align:center; text-shadow: 3px 1px 2px red;">
      <h1>👨🏻‍💻 AI EMPOWERED CAREER MANAGEMENT SYSTEM 👨🏻‍💻</h1>
    </div>
      """
  ...
  html2="""
    <div style="text-align:center; text-shadow: 3px 1px 2px 0RANGE;">
  ...
  html3="""
    ...
    <div style="color:blue; margin:80px; text-align:center;">
      Developed with ❤ by ADITYA SINGH ,MADHAV SINGH, MADHVENDRA SINGH,YUVRAJ SINGH 
    </div>
      """
